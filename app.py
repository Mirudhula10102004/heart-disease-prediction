...
import pandas as pd
import joblib
import json  # Needed to parse secrets

# ✅ Function to log data to Google Sheet using Streamlit Secrets
def log_to_sheet(data):
    ...
    sheet = client.open("heart_user_data").sheet1  # Your sheet name
